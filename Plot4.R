...
## Combining multiple plots and saving plots in Plot4.png

{
        ...
        plot(data_power$Global_active_power ~ data_power$DateTime, type = "l",
        ...
        plot(data_power$Voltage ~ data_power$DateTime, type = "l",
             ylab = "Voltage",
        ...
        plot(data_power$Global_reactive_power ~ data_power$DateTime, type = "l",
